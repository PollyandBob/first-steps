function LandingPageViewModel( gcoder, baseSearchViewUri )
{
    var self = this;
...
LandingPageViewModel.prototype.doSearch = function() {
...
// For jQuery UI Autocomplete binding
LandingPageViewModel.prototype.fenRetrieveSuggestions = function(searchTerm, sourceArray) {
...
LandingPageViewModel.prototype.inputPressEnter = function(data, event) {
    var self = this;
    if ( event.keyCode == 13 )
        self.doSearch( false );
    else
