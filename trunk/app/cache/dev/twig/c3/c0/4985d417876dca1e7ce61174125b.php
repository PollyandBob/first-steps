...
";
    ...
    <script type=\"text/javascript\">
        ...
        echo "';
            var pagination = ";
        // line 45
        echo twig_escape_filter($this->env, (isset($context["pagination"]) ? $context["pagination"] : $this->getContext($context, "pagination")), "html", null, true);
        echo ";
            var usersOwnListing = ";
        // line 46
        echo (((isset($context["usersOwnListing"]) ? $context["usersOwnListing"] : $this->getContext($context, "usersOwnListing"))) ? ("true") : ("false"));
        echo ";
            ";
        // line 47
        if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "security", array(), "any", false, true), "token", array(), "any", false, true), "user", array(), "any", false, true), "id", array(), "any", true, true)) {
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "security"), "token"), "user"), "id"), "html", null, true);
            echo ";
            ";
        } else {
            // line 50
        ...
        echo twig_jsonencode_filter((isset($context["initialReviewsP"]) ? $context["initialReviewsP"] : $this->getContext($context, "initialReviewsP")));
        echo ";
            var initialReviewsN = ";
        // line 53
        echo twig_jsonencode_filter((isset($context["initialReviewsN"]) ? $context["initialReviewsN"] : $this->getContext($context, "initialReviewsN")));
        echo ";
        ...
        echo "'
            ...
            var displayUserId = ";
        // line 66
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["displayUser"]) ? $context["displayUser"] : $this->getContext($context, "displayUser")), "id"), "html", null, true);
        echo ";
            
            var listingId = ";
        // line 68
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["notice"]) ? $context["notice"] : $this->getContext($context, "notice")), "id"), "html", null, true);
        echo ";
    ...
    <section class=\"main content-ltr\" data-role=\"main\">
        ...
        echo "
                                            ";
        // line 123
        if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array(), "any", false, true), "id", array(), "any", true, true) && ($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user"), "id") != $this->getAttribute($this->getAttribute((isset($context["notice"]) ? $context["notice"] : $this->getContext($context, "notice")), "user"), "id")))) {
            // line 124
            echo "                                            <a style=\"float: right;\" href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("fenchy_create_notice_sticker", array("id" => $this->getAttribute((isset($context["notice"]) ? $context["notice"] : $this->getContext($context, "notice")), "id"))), "html", null, true);
        ...
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["notice"]) ? $context["notice"] : $this->getContext($context, "notice")), "startDate"), "M d H:m"), "html", null, true);
        echo " to ";
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["notice"]) ? $context["notice"] : $this->getContext($context, "notice")), "endDate"), "M d H:m"), "html", null, true);
        echo "</span></h2>
                                    </hgroup>                                        
                                </header>
                                <div class=\"post-content\">
                                    ...
                                    ";
        // line 132
        if ($this->getAttribute($this->getAttribute((isset($context["notice"]) ? $context["notice"] : $this->getContext($context, "notice")), "gallery"), "hasImages")) {
            // line 133
            echo "                                        <figure>
                                        ";
            // line 134
            $context["gallery"] = $this->getAttribute((isset($context["notice"]) ? $context["notice"] : $this->getContext($context, "notice")), "gallery");
            // line 135
            echo "                                        ";
        ...
        // line 145
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["notice"]) ? $context["notice"] : $this->getContext($context, "notice")), "tags"), "html", null, true);
        echo "\"/>
                                        </div>
