...
";
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["type"]) {
            // line 37
            echo "                            ";
            $context["dirProp"] = $this->getAttribute((isset($context["type"]) ? $context["type"] : $this->getContext($context, "type")), "hasProperty", array(0 => (isset($context["direction"]) ? $context["direction"] : $this->getContext($context, "direction"))), "method");
            // line 38
            echo "                            ";
            if ((isset($context["dirProp"]) ? $context["dirProp"] : $this->getContext($context, "dirProp"))) {
                // line 39
                echo "                                ";
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["dirProp"]) ? $context["dirProp"] : $this->getContext($context, "dirProp")), "options"));
                foreach ($context['_seq'] as $context["_key"] => $context["opt"]) {
                    // line 40
                    echo "                                <li class=\"action-element\">
                                    <a href=\"";
                    // line 41
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("fenchy_regular_user_notice_create2", array("typename" => $this->getAttribute((isset($context["type"]) ? $context["type"] : $this->getContext($context, "type")), "name"), "direction" => (isset($context["opt"]) ? $context["opt"] : $this->getContext($context, "opt")))), "html", null, true);
                    echo "\">
                    ...
                    echo "_big.png\" alt=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans((isset($context["type"]) ? $context["type"] : $this->getContext($context, "type"))), "html", null, true);
                    echo " ";
                    echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans((isset($context["opt"]) ? $context["opt"] : $this->getContext($context, "opt"))), "html", null, true);
                    echo "\"/>
                                        </span>
                ...
                echo "                                <li class=\"action-element\">
                                    <a href=\"";
                // line 51
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("fenchy_regular_user_notice_create2", array("typename" => $this->getAttribute((isset($context["type"]) ? $context["type"] : $this->getContext($context, "type")), "name"), "direction" => null)), "html", null, true);
                echo "\">
                                        <span class=\"category-btn\">
                                            <img src=\"/images/types/";
                // line 53
