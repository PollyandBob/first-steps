...
class __TwigTemplate_e6661c927123f3ef49e4c5d025d65c4a extends Twig_Template
{
    ...
    {
        // line 2
        $this->env->getExtension('form')->renderer->setTheme((isset($context["form"]) ? $context["form"] : null), array(0 => "::noLabelForm.html.twig"));
...
";
    ...
    ";
        // line 20
        if ($this->getAttribute((isset($context["type"]) ? $context["type"] : null), "locationChangeAvailable")) {
            // line 21
            echo "        ";
...
";
    ...
    <section data-role=\"main\" class=\"main\">
        ...
        echo " ";
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans(($this->getAttribute((isset($context["type"]) ? $context["type"] : null), "name") . "_prefix")), "html", null, true);
        echo "
                                <span>";
        // line 91
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans($this->getAttribute((isset($context["type"]) ? $context["type"] : null), "name")), "html", null, true);
        echo "</span>
                            </h2>
                            <p>";
        // line 93
        ...
        // line 95
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("fenchy_regular_user_notice_create2", array("typename" => $this->getAttribute((isset($context["type"]) ? $context["type"] : null), "name"), "direction" => (isset($context["direction"]) ? $context["direction"] : null))), "html", null, true);
        echo "\" method=\"post\" ";
        ...
        echo "
                                    ...
                                    ";
        // line 102
        $context["subId"] = $this->getAttribute((isset($context["type"]) ? $context["type"] : null), "subcategoryId");
        // line 103
        echo "                                    ";
        if ((isset($context["subId"]) ? $context["subId"] : null)) {
            // line 104
            echo "                                    <div class=\"row grid_4\">
                                        <div id=\"review-type-selector\" class=\"toolbar-item button select-button grey-button pull-right\">
                                            ...
                                            <div class=\"dd-element\" style=\"display:none\">
                                                ";
            // line 114
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "type"), ("value_" . (isset($context["subId"]) ? $context["subId"] : null)), array(), "array"), 'widget');
            echo "
                                            </div>
        ...
        echo "
                                    ...
                                    <div class=\"row fieldInput with_icon grid_6 tags-container\">
                                        ...
                                        ";
        // line 127
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "tags"), 'row');
        echo "
                                    </div>
                                    <div class=\"row fieldInput with_icon grid_2\">
                                        ...
                                        ";
        // line 131
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "start_date"), 'row');
        echo "
                                    </div>                                        
                                    <div class=\"row fieldInput with_icon grid_2\">
                                        <i class=\"icon-calendar\"></i>
                                        ";
        // line 135
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "end_date"), 'row');
        echo "
                                    </div>                                                                                                                        
                                    ";
        // line 137
        ...
        if ($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "put_on_fb", array(), "any", true, true)) {
            ...
            echo "                                        <div class=\"row grid_6\">
                                            ";
            // line 145
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "put_on_fb"), 'row');
            echo "
                                        </div>
                                    ";
        }
    ...
    <script type=\"text/javascript\">
        \$(document).ready(function () {
            var sampleTags = ";
        // line 177
        echo twig_jsonencode_filter((isset($context["tags"]) ? $context["tags"] : null));
        echo ";
