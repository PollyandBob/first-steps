...
class __TwigTemplate_40fe32e9fd737288d31d61291edbae0c extends Twig_Template
{
    ...
    <footer class=\"main\" data-role=\"footer\">
                        ...
                        <ul class=\"clearfix\">
                            <li id=\"lang-menu-chosen\">
                                <a href=\"#\" id=\"choose-lang\"><strong>
                                            ";
        // line 23
        if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request"), "locale") == "pl")) {
            // line 24
            echo "                                                ";
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("frontend.polski"), "html", null, true);
            echo "
                                            ";
        } elseif (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request"), "locale") == "en")) {
            // line 26
            echo "                                                ";
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("frontend.english"), "html", null, true);
            echo "
                                            ";
        } elseif (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request"), "locale") == "de")) {
            // line 28
            echo "                                                ";
        ...
        echo "                                                
                ...
                <div id=\"lang-menu-wrapper\">
                    <ul>
                        ";
        // line 42
        if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request"), "locale") != "en")) {
            // line 43
        ...
        echo "                            
                        ";
        // line 48
        if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request"), "locale") != "de")) {
            echo "                            
                        <li class=\"de-flag\">
                            <a href=\"";
            // line 50
