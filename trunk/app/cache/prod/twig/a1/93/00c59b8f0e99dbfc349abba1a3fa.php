            ...
            foreach ($context['_seq'] as $context["_key"] => $context["notice"]) {
                ...
                echo "                                <article class=\"box mediumbox\">
                                    <figure>
                                        <img src=\"";
                // line 90
                echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl($this->getAttribute((isset($context["notice"]) ? $context["notice"] : null), "avatar", array(0 => false), "method")), "html", null, true);
                echo "\" alt=\"\"/>
                                        <figcaption>
                                            <div>
                                                <h3><a href=\"";
                ...
                echo "</a></h3>
                                                ";
                // line 94
                if (($this->getAttribute($this->getAttribute((isset($context["notice"]) ? $context["notice"] : null), "type"), "name") == "events")) {
                    // line 95
                    echo "                                                    <strong>";
                                    ...
                                    <div class=\"event-master clearfix\">
                                        <div class=\"img\">
                                            <span class=\"image-container small-avatar bordered\">
                                                <img src=\"";
                // line 103
                echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["notice"]) ? $context["notice"] : null), "user"), "regularUser"), "avatar")), "html", null, true);
                echo "\" alt=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["notice"]) ? $context["notice"] : null), "user"), "userRegular"), "firstName"), "html", null, true);
                echo " ";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["notice"]) ? $context["notice"] : null), "user"), "userRegular"), "lastName"), "html", null, true);
                echo "\"/>
                                            </span>
                                        </div>
                ...
                // line 108
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["notice"]) ? $context["notice"] : null), "user"), "location"), "html", null, true);
                echo "</span></a></strong>                                                    
                                        </div>
                                    </div>
                                    <div class=\"activity\">
