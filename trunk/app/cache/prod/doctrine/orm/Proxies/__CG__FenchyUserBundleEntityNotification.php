 ...
 */
class Notification extends \Fenchy\UserBundle\Entity\Notification implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function addUser(\Fenchy\UserBundle\Entity\User $user)
    {
        $this->__load();
        return parent::addUser($user);
    }

    public function removeUser(\Fenchy\UserBundle\Entity\User $user)
    {
        $this->__load();
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'description', 'notification_group', 'users');
    }
